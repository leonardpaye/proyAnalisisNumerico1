...
# Datos actualizados
anios = np.array([2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]).reshape(-1, 1)
tasas_desempleo = np.array([2.0, 2.0, 2.0, 2.0, 2.0, 3.1, 3.5, 3.5, 3.5, 3.5, 8.0, 5.5, 3.0])
